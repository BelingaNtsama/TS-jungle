...
import ProfileSidebar from "@/admin/components/SideBar"; // Assurez-vous que le chemin est correct
  ...
  return (
    <div className="drawer lg:drawer-open">
      ...
      <div className="drawer-content flex flex-col">
        {/* Header */}
        <motion.header
          className="navbar bg-base-100 border-b border-base-300 px-4"
        ...
        >
          ...
          <div className="flex-none">
            <button className="btn btn-ghost btn-circle relative" onClick={() => setShowNotifications(true)}>
